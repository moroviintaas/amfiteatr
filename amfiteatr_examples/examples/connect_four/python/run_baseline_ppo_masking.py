...
def main():
    ...
    env.reset()
    policy0 = PolicyPPO(84, 7, args.layer_sizes_0, config=policy_config, device=device, tb_writer=tb_writer_policy_0, masking=True)
    policy1 = PolicyPPO(84, 7, args.layer_sizes_1, config=policy_config, device=device, tb_writer=tb_writer_policy_1, masking=True)
