...
pub type SchemeCommE512<S> = ComplexComm<EnvironmentMessage<S>, AgentMessage<S>, CommunicationError<S>, 512>;
pub type SchemeCommA512<S> = ComplexComm<AgentMessage<S>, EnvironmentMessage<S>,  CommunicationError<S>, 512>;
